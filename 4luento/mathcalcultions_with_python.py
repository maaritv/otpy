...
try:
  area = calculate_rectange_area(leveys, korkeus)
  print(f"Pinta-ala on {area}")
except ValueError as value_error:
  print(f"Pinta-alan pitää olla positiivinenc numweo. {value_error}\n\n")
except TypeError as type_error:
  print(f"Pinta-ala lasketaan numeroista. {type_error}\n\n")
